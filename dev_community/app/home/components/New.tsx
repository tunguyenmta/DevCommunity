...
function extractTextFromHTML(htmlContent: string) {
  ...
  } else return trimmed.slice(0, dot[2]);
}
const News: React.FC<NewProps> = ({ cards }) => {
  ...
  return (
    <div className="grid md:flex py-5 px-6 md:py-95px md:px-77px md:gap-x-5 gap-y-20 bg-blue6">
                        ...
                        return (
                          <React.Fragment key={tag.id}>
                            <button
                              ...
                              className="underline font-semibold hover:text-blue3 transition duration-500 ease-in-out "
                              onClick={(
                                e: React.MouseEvent<
                                  HTMLButtonElement,
                                  MouseEvent
